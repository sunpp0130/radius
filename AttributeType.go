...
var attributeTypeMap = [256]attributeTypeDesc{
	...
	NASIPv6Address:               {"NASIPv6Address", avpIP},
	FramedInterfaceId:            {"FramedInterfaceId", avpBBinary},
	FramedIPv6Prefix:             {"FramedIPv6Prefix", avpIPPrefix},
	LoginIPv6Host:                {"LoginIPv6Host", avpIP},
	FramedIPv6Route:              {"FramedIPv6Route", avpBinary},
	FramedIPv6Pool:               {"FramedIPv6Pool", avpBinary},
	FramedIPv6Address:            {"FramedIPv6Address",avpIP},
	DNSServerIPv6Address:         {"DNSServerIPv6Address",avpIP},
	RouteIPv6Information:         {"RouteIPv6Information",avpIPPrefix},
	DelegatedIPv6PrefixPool:      {"DelegatedIPv6PrefixPool",avpBinary},
	StatefulIPv6AddressPool:      {"StatefulIPv6AddressPool",avpBinary},
	...
	DelegatedIPv6Prefix:          {"DelegatedIPv6Prefix", avpIPPrefix},
